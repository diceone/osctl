...
var apiEndpoints = []apiEndpoint{
	...
	{"/failed", "GET", "List failed systemd units", nil, ""},
	{"/ports", "GET", "List listening TCP ports with owning process", nil, ""},
	{"/hwinfo", "GET", "Hardware inventory (PCI, USB, kernel modules)", nil, ""},
	{"/timesync", "GET", "Show clock synchronization status", nil, ""},
	{"/report", "GET", "One-shot JSON snapshot of all read-only checks", nil, ""},
